Ext.define("CueTrans.lib.control.cuecustomfileupload",{
		extend:"Ext.container.Container",
		alias: 'widget.cuecustomfileupload',
		...
		initComponent: function(arguments)
		{
			...
			outObj = {
				...
				[
					...
					plf.addText({"label":this.LabelText,id:"fName",width:110,readOnly:true}),
					this.ptrAttachField,
					this.ptrViewField,
					this.ptrClearField
		...
		invokeFileUpload:function()		
		{
			...
			var ptrFileUploadField = Ext.create('Ext.form.Panel', {
								...
								items: 
									...
									{cls: "c-fielddisplabel1",xtype:"label",text:"[upto 5 MB]"}
									]
			});
