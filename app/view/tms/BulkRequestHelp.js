...
************************************************************************************************/
Ext.define('CueTrans.view.tms.BulkRequestHelp', 
{
	...
	/*	mainpage.toolbarSectionFlag=true;
		...
		[
			{"name":"Create Bulk Request","linkid":"tms_createbulkrequest"}
		]*/
		...
		plf.columns = 3
	 var bulkHdrCollapse = plf.addColumnSection({title:"", collapsed: false}); 
		 var bulkFormCtrl=
		[
		...
		[
			{columnname:"Bulk Request No",dataname:"TRANS_REQ_NO",datatype:"string",width:150},
