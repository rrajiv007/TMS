Ext.define('CueTrans.view.tms.TransCargoRequestItemBased', 
{
	...
	initComponent: function()
	{
		...
		var ItemActionCtrl=
			[	
				plf.addHidden({"label":"Action",id:"strAction","mandatory":"true"}),
				plf.addHidden({"label":"Vehicle Category",id:"strVehCat"}),				
				plf.addHidden({"label":"Vehicle Reg No",id:"strVehRegNo",keyField:"strVehCode"},this),
				plf.addHidden({"label":"Vehicle No",id:"strVehCode",hlpLinkID:"vehiclehlp"},this)
		...
		if(plf.defaultLayout==4)
		{
			...
			[	
				...
				plf.addText({"label":"Load At",id:"strLoadAt"}),
				plf.addCombo({"label":"Destination",id:"strDestination","mandatory":"true"}),
				plf.addText({"label":"Unload At",id:"strUnloadAt"}),
		...
		ItemBasedColumn2 = plf.addColumnSection({"hidden":true});
		if(plf.defaultLayout==4)
		{
			plf.columns=4
		...
		ItemBasedColumn3 = plf.addCollapseSection({title:"Default section",collapsed:true})
		if(plf.defaultLayout==4)
		{
			plf.columns=4
			...
			[	
				...
				plf.addText({"label":"Requestor Mail ID",id:"strReqMailId","mandatory":"true"}),
		...
		{       
				...
				"strAction","strVehCat","strVehRegNo","strVehCode"],
				"service":"TMSCoreTransportTS",
		...
		{       
				...
				"input":["strRequestNo","dtRequestDate","strCommodity","strOrigin","strDestination","strDocNo","strCustomerCode",
				"strCustomerName","strContractType","strContractNo","dtPickUpDateTime","dtRosDateTime","strPriority","strWeightUom","strVolumeUom",
				"planDetail","actDetail","refGrid","strDemandStatus","strCostCenterCode","tmPickUpTime","tmROSTime","strRequestorId","strRequestorName","strReqMailId","strStatus","strRemarks","strLogGroup","strDivCode","strVendorCode","strLoadAt"],
				"service":"TMSCoreTransportTS",
