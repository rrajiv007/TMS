...
************************************************************************************************	
1.0.1	 Manibharathi		05/02/2016    69997                         Addition of    
1.0.2    Vidhya             29/Dec/2016   75267                        Help Screen 
                                                                       is not getting closed,even after selecting a Shipment no. and  set visible row 
1.0.3      Vidhya            06/06/2017            79507         Added PO number and Vendor Name																		   
                                         
************************************************************************************************/
Ext.define('CueTrans.view.tms.ShipmentHelp', 
{
			...
			[	
{
			...
			{					
					...
					"strCostCenterCode","strDateType","strDocNo","strPONum","strVendorName"],
					"service":"TMSCoreTransportTS",
