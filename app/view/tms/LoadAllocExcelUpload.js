...
************************************************************************************************/
Ext.define('CueTrans.view.tms.LoadAllocExcelUpload', 
{
	...
	initComponent: function()
	{
		...
		mainpage.toolbarSectionFlag=true;
			...
			{
                "name": "Allocate Load to Vehicle",
                "tooltip": "Click here to bulk load allocation."
            }
			]
		...
		[   
			...
			{columnname:"Vehicle No",dataname:"VEH_REG_NO",datatype:"string",editControl:"textbox",width:140,helpid:'vehreghlp'},
			{columnname:"Driver Code",dataname:"DRIVER_CODE",datatype:"string",width:120,editControl:"textbox",width:140,helpid:'driverhlp'},
			...
			{columnname:"Load Inspection",dataname:"LOAD_INS",datatype:"string",width:120,editControl:"textbox",InputLength:"255",inputFormat:"string"},
		...
		[   
			...
			{columnname:"Load Inspection",dataname:"LOAD_INS",datatype:"string",width:120},
		...
		[
			...
			},
			{
					...
					"action":"Allocate Load to Vehicle",
					"input":["excelDetail"],
					"service":"TMSCoreTransportTS",
					"methodName":"createBulkAllocLoadExcelTS"
			}
		];
