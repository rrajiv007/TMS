	...
	//	mainpage.toolbarActions=["Refresh","Create","Edit","Delete","Confirm","ShortClose","Print"]
		...
		if(plf.defaultLayout==3)
		{
			...
			[	
				...
				plf.addDateTime({"label":"Dept Date/Time",dateid:"dtLoadDate",timeid:"tmLoadTime","mandatory":"true"}),	
				...
				plf.addText({"label":"Load Description",id:"strLoadAt"}),
				plf.addCombo({"label":"Load Inspection",id:"strLoaInsReq"}),
				plf.addText({"label":"Remarks",id:"strRemarks"}),
				plf.addCombo({"label":"Loading Point",id:"strLoadPt"}),  //73364
		...
		*/
		...
		[
			...
			{columnname:"Closure Date",dataname:"CLOSURE_DATE",width:150,datatype:"date",editControl:"date"},
			{columnname:"Closure Time (hh:mm)",dataname:"CLOSURE_TIME",datatype:"string",width:150,editControl:"RegexTime"}
		...
		*/
		...
		var baseTab = plf.addTabSection({id:"baseTabId", tabs:[UnAssignedColumn,AssignedColumn,tmpbtnSection]
		/*
		"listeners":{
		...
		*/
		...
		/*{       
				"controlid":"btnLoadLeg",
				"tasktype":"btnclick",
				"input":["mappedShipGrid","strLoadNo"],
				"service":"TMSCoreTransportTS",
				"methodName":"fetchLoadShipGetLegTS"
		},
		{       
				"controlid":"btnUtil",
				"tasktype":"btnclick",
				"input":["LoadLegDtlGrid","mappedShipGrid","strVehicleCategory","UtilDtlGrid"],
				"service":"TMSCoreTransportTS",
				"methodName":"fetchLoadRouteSugTS"
		},*/
		{       
		...
		{       
				...
				"action":"Edit",
				"input":["strLoadNo","dtLoadDate","tmLoadTime","strStatus","strOrigin","strDestination","strCommodity",
				         "strDemandStatus","strVehicleCategory","mappedShipGrid","strModifiedBy","dtModifiedDate","strRouteCode","strLoaInsReq","strRouteDesc","dtPickUpDateTime","UtilDtlGrid","LoadLegDtlGrid","strUtilization","strLoadAt","strRemarks","strLoadPt","strDelvAt","strWeight"],//73364
				"service":"TMSCoreTransportTS",
