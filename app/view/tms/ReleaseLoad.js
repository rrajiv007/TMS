...
************************************************************************************************/
Ext.define('CueTrans.view.tms.ReleaseLoad', 
{ 
	...
	initComponent: function()
	{
		...
		mainpage.screenName = "Release Load";	
		...
		amendDetails.add(
		/*{xtype:"button",align:"right",text:"Remove Vehicle Allocation",tooltip:"By Clicking here, vehicle allocation will be removed for the load shortclosing inspection and journey if applicable.",columnWidth:.14,margin:3,fieldCls:
		"c-displyonlyctrl",
					handler: function() 
					{
