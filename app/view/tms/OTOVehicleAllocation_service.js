...
************************************************************************************************/
Ext.define('CueTrans.view.tms.OTOVehicleAllocation_service', 
{
	...
	initComponent: function()
	{
		...
		[
			...
			plf.addDisplayOnly({"label":"Primary Service Id",id:"strServiceId"}),
		...
		[
			...
			"input":["strTripNo","strServiceId","strVehCat","strCarrierCode","strDriverCode","strRemarks","strVehCode"],
			"service":"VEHSCHCoreVehSchServiceTS",
			...
			"input":["strTripNo","strServiceId","strVehCat","strCarrierCode","strDriverCode","strRemarks","strReason","strVehCode"],
			"service":"VEHSCHCoreVehSchServiceTS",
			...
			"input":["strTripNo","strServiceId","strVehCat","strCarrierCode","strDriverCode","strRemarks","strReason",
					 "strInsReq","strInsLoc","dtRepDate","tmRepTime","dtReqDate","strVehCode"],
			"service":"VEHSCHCoreVehSchServiceTS",
			"methodName":"allocateOTOVehSchSERTS"	
			},
			{
