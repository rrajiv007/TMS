...
************************************************************************************************/
Ext.define('CueTrans.view.tms.TransReqAmendItemHelp', 
{
		...
		mainpage.eventHandlers = 
			[
			
               {
				...
				"methodName":"initvenReqAmendSummTS"
		      },
			  {       
				"controlid":"searchBtn",
				"tasktype":"btnclick",
				"input":["strRequestNoFrom","dtRequestDateFrom","dtRequestDateTo","strDemandStatus","strStatus","strOrigin",
				"strDestination","strPriority","strCustomerCode","strDateType","strLogGroup","strDivCode","strRequestNoTo","strDocNo","strVendorName","strPONum"],
				"service":"TMSCoreTransportTS",
