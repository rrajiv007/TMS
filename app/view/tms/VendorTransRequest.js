...
************************************************************************************************/
Ext.define('CueTrans.view.tms.VendorTransRequest', 
{
	...
	initComponent: function()
	{
		...
		mainpage.toolbarActions= [{
			...
			{
                "name": "Amend",
                "tooltip": "Click here to Amend a request."
            },
            {
                "name": "Short Close",
			...
			{
                "name": "Print WayBill",
                "tooltip": "Click here to print waybill."
            }
            ]
		...
		var ItemActionCtrl=
			[	
				...
				plf.addText({"label":"Actual Weight",id:"strActualWeight",inputFormat:'numeric',weightPrecision:3}), // numeric
		...
		if(plf.defaultLayout==4)
		{
			...
			[	
				...
				plf.addCombo({"label":"Amend No",id:"iAmendmentNo"/*,"mandatory":"true"*/}),
				...
				plf.addHlpText({"label":"Ref Doc No",id:"strDocNo","mandatory":"true",hlpLinkID:"refdocno"},this),
				...
				plf.addText({"label":"Vendor's Ref No",id:"strVenRefNo","mandatory":"true"}),//Raj 241217
				plf.addDisplayOnly({"label":"Load No",id:"strLoadNoFrom"}),
				plf.addText({"label":"PO No",id:"strPONum","mandatory":"true"}),
				plf.addHidden({"label":"Vendor Name",id:"strVendorCode"}),
		...
		else
		{
			...
			//	plf.addCombo({"label":"Commodity",id:"strCommodity","mandatory":"true"}),
				...
				plf.addText({"label":"Requestor Mail ID",id:"strReqMailId"}),
				plf.addDisplayOnly({"label":"Created type",id:"strCreatedType"}),
				plf.addText({"label":"Remarks",id:"strRemarks",width:255,"mandatory":"true"}),
				plf.addDisplayOnly({"label":"Vendor Code",id:"strVendorName"}),
		...
		[   
			...
			{columnname:"Item Description",dataname:"ITEM_DESC",datatype:"string",width:250},
			{columnname:"Commodity",dataname:"COMMODITY",datatype:"string",width:90},
			{columnname:"Quantity",dataname:"ITEM_QTY",datatype:"string",editControl:"textbox",width:200,"onenter":"QUANTITY_ONENTER",colAlign:'right'},
			{columnname:"UOM",dataname:"ITEM_QTY_UOM",datatype:"string",width:200,storeId:"strQuantityUom"},
			{columnname:"Weight<BR>(ton)",dataname:"TOT_WEIGHT",datatype:"string",width:150,colAlign:'right',weightPrecision:3},
			{columnname:"Volume<BR>(cu.m)",dataname:"TOT_VOLUME",datatype:"string",width:150,colAlign:'right',volumePrecision:3},*/
			{columnname:"Item Code",dataname:"ITEM_CODE",datatype:"string",editControl:"textbox",width:140,helpid:'ItemCodeAct',"onenter":"ITEM_CODE_ONENTER","onkeyup":"ITEM_CODE_ONENTER"},
			{columnname:"Item Description",dataname:"ITEM_DESC",datatype:"string",width:250},
		...
		},
		{
				...
				"tasktype":"onchange",
				"input":["strRequestNo","strRequestNoHid","iAmendmentNo"],
				"service":"TMSCoreTransportTS",
				"methodName":"VenOnchangeAmendNoTS"
		},
		{       
				"controlid":"",
				...
				"strAction","strVehCat","strVehRegNo","strVehCode","strRigNo","strDelvAt","strLoadDesc","strLoadNo","strPONum","iAmendmentNo",
		...
		{       
				...
				"action":"Delete",
				"input":["strRequestNo","dtRequestDate","strCommodity","strOrigin","strDestination","strDocNo","strCustomerCode",
				"strCustomerName","strContractType","strContractNo","dtPickUpDateTime","dtRosDateTime","strPriority","strWeightUom","strVolumeUom","strRigNo",
				"planDetail","actDetail","refGrid","strDemandStatus","strCostCenterCode","tmPickUpTime","tmROSTime","strRequestorId","strRequestorName","strReqMailId","strStatus","strRemarks","strLogGroup","strDivCode","strVendorCode","strLoadAt","strDelvAt","strLoadDesc","strLoadNo","strPONum","strActualWeight","strVenRefNo","iPoLineItem","strItemRemaks"],
				"service":"TMSCoreTransportTS",
		...
		{       
				...
				"strActualWeight","strVenRefNo","iPoLineItem","strItemRemaks"],//71735 changes//73460 changes
				"service":"TMSCoreTransportTS",
				"methodName":"VendauthorizeItemBasedTS"//"authorizeItemBasedTS"
		},
		{       
				"controlid":"",
				"tasktype":"toolbarclick",
				...
				"strCustomerName","strContractType","strContractNo","dtPickUpDateTime","dtRosDateTime","strPriority","strWeightUom","strVolumeUom",
				"planDetail","actDetail","refGrid","strDemandStatus","strCostCenterCode","tmPickUpTime","tmROSTime","strRequestorId","strRequestorName","strReqMailId","strStatus","strRemarks","strLogGroup","strDivCode","strVendorCode","strLoadAt","strNotes",
				"strAction","strVehCat","strVehRegNo","strVehCode","strRigNo","strWellID","strWellName","strSapRigId","strCallout","strDelvAt","strLoadDesc","strLoadNoFrom","strLoadNo","strPONum","iAmendmentNo","strActualWeight","strVenRefNo","iPoLineItem","strItemRemaks"],
				"service":"TMSCoreTransportTS",
				"methodName":"VendorAmendTS"
		},
		{       
				"controlid":"",
				"tasktype":"toolbarclick",
