...
************************************************************************************************	
1.0.1         Raj                18/05/2016      72424                              Excel upload Success msg Changed		                                   
************************************************************************************************/
Ext.define('CueTrans.view.tms.LoadExcelUpload', 
{
	...
	initComponent: function()
	{
		...
		mainpage.toolbarSectionFlag=true;
			...
			{
                "name": "Bulk Load Creation",
                "tooltip": "Click here to create a bulk load."
            }
			]
		...
		[   
			{columnname:"Departure Date",dataname:"PICKUP_DATE",datatype:"string",width:120,editControl:"date"},
			{columnname:"Departure Time",dataname:"PICKUP_TIME",datatype:"string",width:120,editControl:"time"},
			{columnname:"Vehicle Category",dataname:"VEH_CAT",datatype:"string",width:120,editControl:"combo",storeId:"strVehCat"},
			{columnname:"Origin",dataname:"ORIGIN",datatype:"string",width:120,editControl:"combo",storeId:"strOrigin"},
			{columnname:"Destination",dataname:"DESTINATION",datatype:"string",width:120,editControl:"combo",storeId:"strDestination"},
			{columnname:"Vehicle No",dataname:"VEH_REG_NO",datatype:"string",editControl:"textbox",width:140,helpid:'vehreghlp',hidden:true},
			{columnname:"Driver Code",dataname:"DRIVER_CODE",datatype:"string",width:120,editControl:"textbox",width:140,helpid:'driverhlp',hidden:true},
			{columnname:"Load Description",dataname:"LOAD_AT",datatype:"string",width:120,editControl:"textbox",InputLength:"255",inputFormat:"string"},
			{columnname:"Load Inspection",dataname:"LOAD_INS",datatype:"string",width:120,editControl:"textbox",InputLength:"255",inputFormat:"string"},//,hidden:true
			{columnname:"Remarks",dataname:"REMARKS",datatype:"string",width:120,editControl:"textbox",InputLength:"255",inputFormat:"string"},
			{columnname:"Load At",dataname:"REQ_NAME",datatype:"string",width:120,editControl:"combo",storeId:"strRequestorName"},
			{columnname:"Delivery At",dataname:"REQ_ID",datatype:"string",width:120,editControl:"combo",storeId:"strRequestorId"},
			{columnname:"Vehicle Inspection",dataname:"REQ_MAIL",datatype:"string",width:120,editControl:"textbox",hidden:true},
			{columnname:"Inspection Loc",dataname:"COST_CENTER_CODE",datatype:"string",width:140,editControl:"textbox",helpid:'lochlp',hidden:true},
			{columnname:"Inspection Date",dataname:"DELIVERY_DATE",datatype:"string",width:110,editControl:"date",hidden:true},
			{columnname:"Inspection Time",dataname:"DELIVERY_TIME",datatype:"string",width:110,editControl:"time",hidden:true}
		]
		 ExcelmaterialDetailsPlan=
		{
			...
			removeExport:true,
			readonly:true,
			importTemplate:"excelTemplate/Bulk Load Creation via Excel.xls"
		}
		...
		[
			...
			},
			{
					...
					"action":"Bulk Load Creation",
					"input":["excelDetail"],
					"service":"TMSCoreTransportTS",
					"methodName":"createBulkLoadExcelTS"
			}
		];
