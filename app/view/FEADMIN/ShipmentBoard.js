Ext.define('CueTrans.view.FEADMIN.ShipmentBoard', 
/****************************************************************************************************************
...
****************************************************************************************************************/
{
	...
	initComponent: function()
	{
		...
		[		
			...
			{columnname:"Click here to launch the manage order.",dataname:"SHIP_LINK_ID",width:70,linkId:"MANAGE_ORDERS",imageURL:"resources/images/grid/Journey/Grid_Re_Create.png"},
			{columnname:"Click here to launch the receive shipment.",dataname:"REC_LINK_ID",width:70,linkId:"RECEIVE_SHIPMENTS",imageURL:"resources/images/grid/Journey/Grid_Re_Create.png"},
		...
		mainpage.dataHistorySectionFlag=false;
			...
			[
				  
               {
				...
				"input":[""],
				"service":"FXCoreTS",
				"methodName":"initSEShipSummaryTS"
		      },
			  {
				"controlid":"strStatus",
				"tasktype":"onchange",
