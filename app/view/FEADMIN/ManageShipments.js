Ext.define('CueTrans.view.FEADMIN.ManageShipments', 
/****************************************************************************************************************
...
****************************************************************************************************************/
{
	...
	initComponent: function()
	{
		...
		mainpage.screenName = "Manage Shipment";
		...
		[
			plf.addHlpText({"label":"Origin",id:"strCueOrigin",hlpLinkID:"orgloc"},this),
			plf.addHlpText({"label":"Destination",id:"strCueDestination",hlpLinkID:"destloc"},this),
			plf.addButton({id:"btnGetRate",label:"Get Rate & Vehicle Category",tooltip:"Click here to get rate and vehicle category."}),
			
			plf.addText({"label":"Rate(OMR)","id":"strRate"}),
			plf.addHlpText({"label":"Vehicle Category",id:"strVehicleCat",hlpLinkID:"Vehicle"},this)
		]
		...
		mainpage.dataHistorySectionFlag=true;
			...
			[
				  
               {
				...
				"input":["strShipmentNo"],
				"service":"FXCoreTS",
				"methodName":"initShipperManageShipTS"
		      },
			  {       
				"controlid":"",
				"tasktype":"toolbarclick",
				"action":"Send Quote",
				"input":["strShipmentNo","strCueOrigin","strCueDestination","strVehicleCat","strRate"],
				"service":"FXCoreTS",
				"methodName":"SendQuoteTS"
			 },
			  {       
				"controlid":"",
				"tasktype":"toolbarclick",
			 ...
			 {       
				"controlid":"btnGetRateff",
				"tasktype":"btnclick",
				"input":["strCueOrigin","strCueDestination"],
				"service":"FXCoreTS",
				"methodName":"GetRateTS"
			}
