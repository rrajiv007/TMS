Ext.define('CueTrans.view.LiveDashboard.costutil', 
{
	...
	initComponent: function()
	{
		...
		[			
			...
			{columnname:"Monthly Cost",dataname:"MON_COST",datatype:"string",width:110,colAlign:'right'},
			{columnname:"Utilized Cost",dataname:"UTIL_COST",datatype:"string",width:110,colAlign:'right'},
			{columnname:"Idle Cost",dataname:"IDLE_COST",datatype:"string",width:100,colAlign:'right'}	,
			{columnname:"Standby Cost",dataname:"STAND_COST",datatype:"string",width:120,colAlign:'right'}	
		]
