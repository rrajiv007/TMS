...
Ext.define('CueTrans.view.common.ContentPanel', 
{
	...
	appScreenJS:"",
	reportScreenJS:"",
	dashboardJS:"",/*code added for id: 57410*/
	//dashboard_flag:true
	...
	loadReportScreen:function(tmp_reportScreen,tmp_initialValues)
	{	
		
		if(tmp_reportScreen != undefined && tmp_reportScreen != "" && this.reportScreenJS != tmp_reportScreen)
		{
			this.reportScreenJS = tmp_reportScreen
		...
		if(this.reportScreenJS != "")
		{
			...
			//this.setActiveTab(this.reportContainerPtr)
			//this.reportContainerPtr.setActiveTab(this.reportScreenPtr)
		}		
	},
	loadReportResult:function()
	{
		this.reportContainerPtr.setActiveTab(this.reportResultPtr)
	},	
	/*code added for id: 57410 starts here*/
	loadDashboardScreen:function(tmp_dashboardScreen,tmp_initialValues)
	{
		if(tmp_dashboardScreen != undefined && tmp_dashboardScreen != "" && this.dashboardJS != tmp_dashboardScreen)
		{
			this.dashboardJS = tmp_dashboardScreen
		...
		if(this.dashboardJS != "")
		{
			if(this.dashboardPtr.items.getCount()==0)
			{
				...
				this.dashboardPtr.removeAll();
				this.dashboardPtr.add(tmpDashboardObj);/*code added for id: 57410*/
			}
	...
	initComponent: function()
	{
		...
		Ext.define('homePageModel', {
			...
			fields: [
				...
				{ name:'dashboardJS', type:'string' },/*code added for id: 57410*/
		...
		me.searchScreenPtr = Ext.create("Ext.panel.Panel",{
			...
			width:plf.screenWidth-plf.appMargin-10,
		...
		/*
		me.reportResultPtr = Ext.create("Ext.panel.Panel",{
			id: 'contentpanel_reportresult',
			width:plf.screenWidth-plf.appMargin,
		...
		me.reportContainerPtr = Ext.create("Ext.tab.Panel",{
			id: 'contentpanel_reportcontainer',
			width:plf.screenWidth-plf.appMargin,
		...
		*/
		...
		/*code added for id: 57410 starts here*/	
		me.dashboardPtr = Ext.create("Ext.panel.Panel",{
			id: 'contentpanel_dashboardscreen',
			width:plf.screenWidth-plf.appMargin-10,
			autoScroll: false,
			layout:'fit',
			border:false,
		...
		//me.add(me.reportContainerPtr);
		
		me.add(me.dashboardPtr);/*code added for id: 57410*/
		/*
