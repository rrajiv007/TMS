...
************************************************************************************************	
	1.0.0    Divya          7.6.2016        72908                                   
************************************************************************************************/
Ext.define('CueTrans.view.Report.CargoTrackingReport', 
{
	...
	initComponent: function()
	{
		...
		mainpage.screenName = "Cargo Tracking Report";
		...
		*/
		...
		[	
			...
			plf.addCombo({"label":"To Region",id:"strRequestNoTo"}),
			//plf.addCombo({"label":"Customer",id:"strJourneyNoTo"}),
			//strRequestNoTo
			...
			plf.addText({"label":"Rig No",id:"strInspectionNoFrom"}),
			plf.addText({"label":"Rig ID",id:"strRigNo"}),
...
/*		
		...
		[
		  plf.addBlank(),
		  plf.addButton({"label":"Show Details","id":"getcargoTrack"}),
		  plf.addButton({"label":"Generate PDF","id":"CargoReport"}),
		  plf.addBlank(),
		  /*
		...
		{columnname:"Vehicle No",dataname:"VEHICLE_NO",datatype:"string",width:100},
		...
		{columnname:"Derived Status",dataname:"DERIVED_STATUS",datatype:"string",width:150},
		{columnname:"Tracking Status",dataname:"TRACKING_STATUS",datatype:"string",width:150},
		{columnname:"Rig ID",dataname:"SAP_RIG_NO",datatype:"string",width:100},
...
*/						
				...
				"methodName":"PrintCargoTrackingReport"
		...
		{       
			...
			{		
				...
				"input":[
						...
						"strVehicleCodeFrom","strInspectionNoTo","dtDateFrom","dtDateTo","strLoadNoTo","strJourneyNoTo",
						"strStatus","strCustomerName","strDocNo","strRequestorId","strWBSNo","strItemCode","strDateType","strDivCode","strItemLevel",
						"strYear","strMonth","strRequestNoTo","strInspectionNoFrom","strRigNo","strWellID","strWellName","strCallout"			
						],
				"service":"CoreReportService",
				"methodName":"getCargoTrackingDtl"
