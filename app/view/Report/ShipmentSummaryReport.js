...
1.0.1    Divya              24/5/16 		                                   
************************************************************************************************/
Ext.define('CueTrans.view.Report.ShipmentSummaryReport', 
{
	...
	initComponent: function()
	{
		...
		mainpage.screenName = "Shipment Summary Report";
		...
		[
		  plf.addBlank(),
		  plf.addButton({"label":"Show Details","id":"getshipmentRequest"}),
		  plf.addButton({"label":"Generate PDF","id":"shipmentRequest"}),
		  plf.addBlank()
		...
		{columnname:"Item Qnty",dataname:"ITM_QTY",datatype:"string",width:150},
		...
		{columnname:"Distance",dataname:"TOT_DISTANCE",datatype:"string",width:150},
		...
		*/
		...
		ShipSummarydetails=
		{
			title:"Shipment Summary Details",
			id:"shipsummdetails",
			detail:ShipSummarygrid,
			visibleRow:15,
			removeExport:false,
			readonly:true
		}
		ShipSummarySection = plf.addGrid(ShipSummarydetails,this)
		...
		mainpage.ptrMainSection.add(ShipSummarySection)
		...
		[	
			...
			{		
				...
				"input":[
						...
						"strVehicleCodeFrom","strInspectionNoTo","dtDateFrom","dtDateTo","strLoadNoTo","strJourneyNoTo","strStatus",
						"strCustomerName","strDocNo","strRequestorId","strWBSNo","strItemCode","strDateType","strDivCode","strItemLevel",
						"strHub","strYear","strMonth","strRigNo"					
			...
			{		
				"controlid":"getshipmentRequest",
				"tasktype":"btnclick",
				"input":[
						"strRequestNoFrom","strShipmentNoFrom","strLoadNoFrom","strJourneyNoFrom","strLogGroup","strRegion",
						"strOrigin","strDestination","strPriority","strCommodity","strCarrierCode","strDriverCodeFrom","strCustomerName",
						"strVehicleCodeFrom","strInspectionNoTo","dtDateFrom","dtDateTo","strLoadNoTo","strJourneyNoTo",
						"strStatus","shipsummdetails","strDocNo","strRequestorId","strWBSNo","strItemCode","strDateType","strDivCode","strItemLevel",
						"strHub","strYear","strMonth","strRigNo"										
						],
				"service":"CoreReportService",
				"methodName":"getShipmentReportXL"
			...
			},
			{
				...
				"input":["strItemLevel"],
				"service":"CoreReportService",
				"methodName":"onchange_ShipItemLevel"
			}
