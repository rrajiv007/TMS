...
************************************************************************************************/
Ext.define('CueTrans.view.Report.CoastalSummaryReport', 
{
	...
	initComponent: function()
	{
		...
		mainpage.screenName = "Coastal Summary";
		...
		[
		  ...
		  */
		  ...
		  plf.addButton({"label":"Generate PDF",id:"CoastalSummary"}),
		  plf.addBlank()
		...
		[   
			...
			{columnname:"Origin Type",dataname:"ORIGIN_TYPE",datatype:"string",width:150},
			{columnname:"Destination",dataname:"DESTINATION",datatype:"string",width:150},
			{columnname:"Destination Type",dataname:"DESTINATION_TYPE",datatype:"string",width:150},
		...
		CoastalSummarydetails=
		{
			title:"Coastal Tracking Details",
			id:"CoastalSummarydtl",
			detail:CoastalSummarygrid,
			visibleRow:15,
			removeExport:false,
			readonly:true
		}
		CoastalSummaryGridSection = plf.addGrid(CoastalSummarydetails,this)
		...
		mainpage.ptrMainSection.add(CoastalSummaryGridSection)//--Golive		
		/*
		mainpage.hlpLinks=
		{
                "requestnofrom":
		...
		*/
		...
		{       
			...
			{       
			    ...
			    "service":"CoreReportService",
				"methodName":"printCoastalSummaryReport"
			}
			//--Golive BEGINS
			,{       
