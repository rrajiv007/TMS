...
************************************************************************************************/
Ext.define('CueTrans.view.Report.JPSummaryReport', 
{
	...
	initComponent: function()
	{
		...
		mainpage.screenName = "Journey Summary Report";
		...
		*/
		...
		[			
			...
			plf.addText({"label":"Request Number",id:"strRequestNoFrom"}),
			plf.addCombo({"label":"Journey Status","id":"strStatus"}),
			
			plf.addText({"label":"Route Code",id:"strRouteCode"}),
...
//			plf.addCombo({"label":"Include",id:"strInclude"})
		...
		[
		  plf.addBlank(),
		  plf.addButton({"label":"Show Details","id":"getjourneysummary"}),
       ...
       JourneySummarygrid=
		[   
			...
			{columnname:"Last Intransit Point",dataname:"LAST_INTRANSIT",datatype:"string",width:200},
			{columnname:"Last IVMS update",dataname:"LAST_IVMS",datatype:"string",width:100},
			...
			{columnname:"Journey Manager",dataname:"JOURNEY_MANAGER_NAME",datatype:"string",width:100},
			...
			{columnname:"Licence No",dataname:"LICENCE_NO",datatype:"string",width:150},
			...
			//{columnname:"Load At",dataname:"LOAD_AT",datatype:"string",width:150},
			//{columnname:"Delivery At",dataname:"DELV_AT",datatype:"string",width:150},
		...
		*/
		...
		[	
			...
			{ 
				...
				"methodName":"InitReportJPSummary"
			},
			...
			{       
				...
				"tasktype":"btnclick", 
				"input":[
					"strRegion","strHub","strOrigin","strDestination","strJourneyNoFrom","strJMname","strInspectionNoFrom","strRouteCode","strDriverCodeFrom","strMobileNo",
					"strVehicleCodeFrom","strContractNo","strShipmentNoFrom","strDocNo","strLoadNoFrom","strTripNo","strStatus","strCarrierCode","strNightDriving","strDateType",
					"dtDateFrom","dtDateTo","strYear","strMonth"				
						],
			    "service":"CoreReportService",
				"methodName":"printListJourneyReport"
			},
			{       
				"controlid":"getjourneysummary",
				"tasktype":"btnclick", 
				"input":[
					"strRegion","strHub","strOrigin","strDestination","strJourneyNoFrom","strJMname","strInspectionNoFrom","strRouteCode","strDriverCodeFrom","strMobileNo",
					"strVehicleCodeFrom","strContractNo","strShipmentNoFrom","strDocNo","strLoadNoFrom","strTripNo","strStatus","strCarrierCode","strNightDriving","strDateType",
			    ...
			    "service":"CoreReportService",
				"methodName":"printJourneySummaryDtl"
			}			
		];
