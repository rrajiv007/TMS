...
************************************************************************************************/
Ext.define('CueTrans.view.Report.OTOWorkReport', 
{
	...
	initComponent: function()
	{
		...
		mainpage.screenName = "OTO Work Distribution Statistics";
		...
		*/
		...
		[
			...
			plf.addCombo({"label":"Destination Location",id:"strShipmentNoTo"}),
			plf.addText({"label":"Contract No",id:"strTripNo"}),
			plf.addCombo({"label":"Date Type",id:"strDateTypes"}),
...
/*
		...
		[
		  plf.addBlank(),
		  plf.addButton({"label":"Show Details","id":"GetOTOWorkReportDetails"}),//Golive	  
		  plf.addButton({"label":"Generate PDF","id":"carrierworkstatisics"}),
		  plf.addBlank()		
		]	
		...
		[   
			...
			{columnname:"Contract Vehicle",dataname:"CONTRACT_VEHICLE",datatype:"string",width:150},//Raj 74629
            {columnname:"Reported Vehicle",dataname:"REPORTED_VEHICLE",datatype:"string",width:150},//Raj 74629
			{columnname:"Loading From",dataname:"Loading_From",datatype:"string",width:150},
			{columnname:"Destination",dataname:"DESTINATION_DESC",datatype:"string",width:150},
			{columnname:"Region",dataname:"REGION_DESC",datatype:"string",width:150},
			...
			{columnname:"JP No",dataname:"JOURNEY_NO",datatype:"string",width:150},
			{columnname:"JP Departure Date",dataname:"DEPARTURE_DATE",datatype:"string",width:150}
			
			//{columnname:"Origin",dataname:"ORIGIN",datatype:"string",width:150},
		
		//{columnname:"Customer",dataname:"CUSTOMER",datatype:"string",width:150}
		
		]
		JourneyViolationsdetails=
		{
			title:"OTO Work Detail",
			id:"OTOWorkdtl",
 ...
 "LoadFrom":
		...
		[	
         
			{
				...
				"tasktype":"btnclick",
				"input":[
				"strRegion","strShipmentNoTo","strTripNo","strDateTypes","dtDateFrom","dtDateTo"
				/*"strLoadNoFrom","strLoadNoTo","strCustomerCode","strCarrierCode","dtDateFrom","dtDateTo","strJourneyNoFrom","strJourneyNoTo"*/
				],
				"service":"CoreReportService",
				"methodName":"CarrierWokListReport"
			},
			 {
				"controlid":"GetOTOWorkReportDetails",
				"tasktype":"btnclick",
				"input":[
				"strRegion","strShipmentNoTo","strTripNo","strDateTypes","dtDateFrom","dtDateTo"
				/*"strLoadNoFrom","strLoadNoTo","strCustomerCode","strCarrierCode","dtDateFrom","dtDateTo","strJourneyNoFrom","strJourneyNoTo"*/
