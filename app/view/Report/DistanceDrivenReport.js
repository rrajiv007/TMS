...
************************************************************************************************	
1.0.1          divya        3/06/2016      72873  
************************************************************************************************/
Ext.define('CueTrans.view.Report.DistanceDrivenReport', 
{
	...
	initComponent: function()
	{
		...
		mainpage.screenName = "Distance Driven Report - Interior";
		...
		*/
		...
		[   
			...
			{columnname:"Created Date",dataname:"CREATED_DATE",datatype:"string",width:125},
			{columnname:"Load Date",dataname:"JP_DT",datatype:"string",width:125},
		...
		[	
         { 
				...
				"methodName":"InitReportScreen_Dist"
			},
		{       
			    ...
			    "service":"CoreReportService",
				"methodName":"printDistanceDrivenReport"
			},
{       
				...
				"input":[
						...
						"strRegion","strRequestNoTo","strShipmentNoTo","strJourneyNoFrom","strDriverCodeFrom","strInspectionNoFrom",
						"strDriverName","strMobileNo","strVehicleRegno","strContNo","strShipmentNoFrom","strVehicleNo","strVehicleCodeFrom",
						"strInspectionNoTo","strLoadNoFrom","strTripNo","strRequestNoFrom","strCommodity","strCarrierCode","strDateT","dtDateFrom","dtDateTo","strDocNo","strLoadType"
				/*
						"strRequestNoFrom","strShipmentNoFrom","strLoadNoFrom","strJourneyNoFrom","strInspectionNoFrom","strRegion",
						"strRequestNoTo","strShipmentNoTo","strPriority","strCommodity","strCarrierCode","strDriverCodeFrom",
						"strVehicleCodeFrom","strInspectionNoTo","dtDateFrom","dtDateTo","strLoadNoTo","strJourneyNoTo","strLocation","strDrivername","strDriverno"	
*/						
			    ...
			    "service":"CoreReportService",
				"methodName":"printDistanceDrivenDtl"
			}			
		];
