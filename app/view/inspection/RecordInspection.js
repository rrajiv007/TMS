...
************************************************************************************************	
1.0.0		 steffie       18/01/2016        69999             Inspector Name in main screen   
1.0.1	       Manibharathi	 05/02/2016    	 69997             Addition of var      
1.0.2		 steffie       03/02/2016        69624            Inspector short close 
1.0.3          Raj           28/06/2016        73192           Changed Load at to Loading Point and Delivery at to Unloading point
1.0.4        Raj            15/12/2016         74993
************************************************************************************************/
Ext.define('CueTrans.view.inspection.RecordInspection', 
{
	...
	initComponent: function()
	{
		...
		mainpage.screenName = "Record Inspection";
		...
		mainpage.toolbarActions= 
			[
				...
				{
					"name": "Print Waybill",
					"tooltip": "Click here to print waybill report."
				},
                //69624 changes
				{
					"name": "Short Close",
					"tooltip": "Click here to Short Close inspection."
				},
				{
					"name": "No Show",
					"tooltip": "Click here to no show."
				},
				{
					"name": "Send Approval",
					"tooltip": "Click here to send to send approval."
				}
				
				/*{
					"name": "Print Load Insp",
		...
		[	
			...
			plf.addCombo({"label":"Inspection Step","id":"strInspectionType"}),
			plf.addCombo({"label":"Amendment Number","id":"iAmendmentNo"}),
			...
			plf.addDisplayOnly({"label":"Truck Document",id:"strTruckDocuments"}),
			...
			plf.addDisplayOnly({"label":"Driver Document",id:"strDriverDocuments"}),
			
			plf.addDisplayOnly({"label":"Asset Code",id:"strAssetCode"}),
			plf.addDisplayOnly({"label":"Asset Description",id:"strAssetDesc"}),
			plf.addDisplayOnly({"label":"Asset Document",id:"strAssetDocuments"})		
			*/
			//Raj Below commented
			/*
                     plf.addHlpText({"label":"Inspection No",id:"strInspectionNo","mandatory":"true",hlpLinkID:"inspectionno"},this),
			plf.addDateTime({"label":"Inspection Date/Time",dateid:"dtInspectionDate",timeid:"iInspectionTime","mandatory":"true"}),
			//plf.addCombo({"label":"Amendment Number","id":"iAmendmentNo"}),
			...
			plf.addDisplayOnly({"label":"Loading Point","id":"strLoadAt"}),//73192
			plf.addDisplayOnly({"label":"Unloading Point","id":"strDeliveryAt"}),//73192
                     //plf.addDisplayOnly({"label":"Load At","id":"strLoadAt"}),
			//plf.addDisplayOnly({"label":"Delivery At","id":"strDeliveryAt"}),
			...
			//plf.addDisplayOnly({"label":"Truck Description",id:"strTruckDesc"}),
			plf.addDisplayOnly({"label":"Driver Name",id:"strDriverName"}),
			plf.addDisplayOnly({"label":"Driver Ph No",id:"strDriverPhNo"}),
			
			plf.addDisplayOnly({"label":"Carrier Name","id":"strCarrierName"}),
			plf.addDisplayOnly({"label":"Request No",id:"strRequestNo"}),	
			
			plf.addDisplayOnly({"label":"Inspection Step","id":"strInspectionType"}),
			plf.addHlpText({"label":"Reporting Driver","id":"strReportingDriver",hlpLinkID:"reportingdriver"},this),
			plf.addHlpText({"label":"Reporting Vehicle","id":"strReportingVehicle",hlpLinkID:"reportingvehicle"},this),
			//69999 changes
...
//Check list Grid Section starts
 ...
 /******* Tyre Photo upload section end here ****************/
		...
		[
			plf.addText({"label":"Driver Side",id:"strRTyrePressure",inputFormat:'integer',InputLength:"3"/*weightPrecision:3*/}),
			plf.addText({"label":"Passenger Side",id:"strLTyrePressure",inputFormat:'integer',InputLength:"3"/*weightPrecision:3*/})
		]
	...
	//Tyre Manufacturing Section Begins
		...
		[
			...
			plf.addTextArea({"label":"RFID Remarks",id:"strRFIDRemarks",InputLength:"400"}),
			plf.addBlank(), 
			plf.addBlank()
		]
	...
	//	mainpage.ptrMainSection.add(checkListGridSection)
		...
		[
		{
			...
			},
			{
				...
				"msg":"Are you sure you want to No Show the Inspection?"
				//completed
            ...
            //69624 changes
			{
				...
				"msg":"Are you sure you want to short close the Inspection?"
				//completed
			...
			},
			{
				...
				"msg":"Are you sure you want to send approval?"
	   ...
	   ,
		{        
				"controlid":"",
				"tasktype":"toolbarclick",
				"action":"Print Load Insp",
                "input":["strInspectionNo"],
				"service":"CoreReportService",
				"methodName":"PrintLoadInspectReport"
	   }*/
