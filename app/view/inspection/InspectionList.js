...
************************************************************************************************	
1.0.2	    Raj        		4/2/2016      67607                   Update for Ref doc no.		
1.0.3	 Manibharathi		05/02/2016    69997                      Addition of var  
1.0.4	 Steffie		    20/03/2016    71027                     Adding Origin and Destination                                   
************************************************************************************************/
Ext.define('CueTrans.view.inspection.InspectionList', 
{
	...
	//	var mainpage = Ext.create("CueTrans.lib.plfTransScreen");
		...
		[
			...
			//plf.addText({"label":"Driver Licence No",id:"strDriverLicenceNo"}),//Raj 14-09-17
			...
			// plf.addHidden({"label":"Inspection Type","id":"strInspectionType"})
            // plf.addBlank({}),
		...
		[
			...
			{columnname:"Inspection Date<BR>& Time",dataname:"INS_DT_TIME",datatype:"string",width:140},
			...
			{columnname:"Reporting Driver No",dataname:"REPORTING_DRIVER_NO",datatype:"string",width:130},			
		...
		[
			...
			"strLoadNo","strCarrierCode","strVehicleCategory","strDriverLicenceNo","strDriverMobileNo","strCarrierType", //"strRequestNo"
			"strRegNo","strReportingDriver","strReportingVehicle","strDocNo","strOrigin","strDestination","strReInspected"],//71027 changes
