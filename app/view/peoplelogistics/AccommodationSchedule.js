...
************************************************************************************************/
Ext.define('CueTrans.view.peoplelogistics.AccommodationSchedule', 
{
	...
	initComponent: function()
	{
		...
		mainpage.screenName = "Accomodation Schedule";
		// Add Toolbar
		...
		[
			...
			plf.addText({"label":"Guest Code",id:"strCampId"}),
			plf.addText({"label":"Guest Name",id:"strCampName"}),
		...
		var accSchGridDtl=
		{
			title:"Accomodation Schedule From 01-Aug-2015 to 31-Aug-2015",
			id:"truckList",
