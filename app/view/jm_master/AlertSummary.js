...
************************************************************************************************/
Ext.define('CueTrans.view.jm_master.AlertSummary', 
{
	...
	initComponent: function()
	{
		...
		[	
			...
			},
			{
				"controlid":"btnSearch",
				"tasktype":"btnclick",
				"input":["strAlertCode", "strAlertDesc", "strModule", "strStatus", "strAlertOn", "dtEffectiveDtFrom", 
				"dtEffectiveDtTo", "strTo", "strCc", "strBcc", "strSubject", "strBody"],
				"service":"PPLCoreMasterTS",
		...
		mainpage.screenLinks=
		{
			"Alert":
				{
					"dest":"jm_master.AlertConfiguration",
					"hdr":[
							{"src":"","dest":""}							
							],
					"grid":[
