...
extend:"CueTrans.lib.plfTransScreen",
	initComponent: function()
	{
		...
		mainpage.toolbarActions=["Refresh","Create","Edit","Delete","Authorize","ShortClose","Print"]
		
		//Add Keyfields
		//mainpage.keyFields=["strUserType"]
		//LoadBuilding Section  Section Begins
		plf.columns=4
		var LoadBuildingColumn = plf.addColumnSection({});			//69995
		if(plf.defaultLayout==3)
		{
			plf.columns=3
			
			var LoadBuildingCtrl=			//69995
			[	
				...
				plf.addDisplayOnly({"label":"Vehicle Capacity",id:"strVehicleCapacity","mandatory":"true"}),
                            plf.addDisplayOnly({"label":"Total Shipment Weight",id:"strTotShipWeight","mandatory":"true"}),
		...
		var LoadBuildingCtrl=		//69995
			[	
                ...
                plf.addDisplayOnly({"label":"Total Shipment Weight",id:"strTotShipWeight"}),
                plf.addDisplayOnly({"label":"Utilization %",id:"strUtilization"}),
		...
		var unmappedShipmentDetails = plf.addColumnSection({title:"Shipments Search"});			//69995
		var unmappedShipmentsFormCtrl=															//69995			
		[
