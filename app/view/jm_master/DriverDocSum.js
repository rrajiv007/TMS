...
************************************************************************************************/
Ext.define('CueTrans.view.jm_master.DriverDocSum', 
{
	...
	initComponent: function()
	{
		...
		mainpage.screenName = "Driver Document Summary";
		...
		[
			{"name":"Manage Driver Documnet","linkid":"jm_driverMst","tooltip":"Click here to create a driver."}/*,
		...
		mainpage.screenLinks=
		{
			"driverMaster":
			{
				"dest":"jm_master.DriverDocMaster",
				"hdr":[
						{"src":"","dest":""}							
						],
				"grid":[
