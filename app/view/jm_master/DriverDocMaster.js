...
************************************************************************************************/
Ext.define('CueTrans.view.jm_master.DriverDocMaster', 
{
	...
	initComponent: function()
	{
		...
		mainpage.screenName = "Driver Document Master";
		// Add Toolbar
		...
		[	
			...
			plf.addDisplayOnly({"label":"Driver Name",id:"strDriverName",inputFormat:"string",InputLength:"100"}),
		...
		[	
		    plf.addDisplayOnly({"label":"Driver Phone No",id:"strDriverPhoneNo","mandatory":"true",inputFormat:"string",InputLength:"20"}),
			plf.addDisplayOnly({"label":"Carrier Name",id:"str3plOwnerName",inputFormat:"string",InputLength:"100",keyField:"str3plOwnerCode"},this),
			//plf.addHlpText({"label":"Carrier Code",id:"str3plOwnerCode","mandatory":"true",hlpLinkID:"3plowner"},this),
			plf.addDisplayOnly({"label":"Carrier Code",id:"str3plOwnerCode"}),
			plf.addDisplayOnly({"label":"Driver Type",id:"strDriverType"}),
			...
			plf.addDisplayOnly({"label":"Nationality Id",id:"strNationalityId",inputFormat:"string",InputLength:"40"}),
			plf.addDisplayOnly({"label":"IVMS Blue Key No",id:"strIvmsKeyNo",inputFormat:"string",InputLength:"40"}),
			plf.addDisplayOnly({"label":"Contract No",id:"strContractNum",inputFormat:"string",InputLength:"100"}),
			plf.addDisplayOnly({"label":"Remarks",id:"strRemarks",inputFormat:"string",InputLength:"250"}),
			plf.addDisplayOnly({"label":"Date of Birth",id:"dtDOB"}),
		...
		*/
		...
		[   
			...
			{columnname:"Issue Date",dataname:"ISSUE_DT",datatype:"string",width:130,editControl:"date"},
			{columnname:"Effective From",dataname:"EFFECTIVE_FROM",datatype:"string",width:140,editControl:"date"},
			{columnname:"Effective To",dataname:"EFFECTIVE_TO",datatype:"string",width:130,editControl:"date"},
		...
		ActivateInactivateReason = plf.addColumnSection({title:"Activate/Inactivate Reason"});
		plf.columns=2
		...
		[
			{
				...
				"methodName":"initDriverDocMasterTS"
			},	

			{
				...
				"input":["strDriverCode"],
				"service":"CoreDriveService",
				"methodName":"onenterDriverDocMasterTS"
			},/*	
			...
			},*/	
			{
				...
				"action":"Submit",
				"input":["strDriverCode","driverMapping","licenceMapping"],
				"service":"CoreDriveService",
				"methodName":"submitDriverDocTS"
				}
			/*
			{
