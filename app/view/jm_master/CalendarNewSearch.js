...
************************************************************************************************/
Ext.define('CueTrans.view.jm_master.CalendarNewSearch', 
{
	...
	initComponent: function()
	{
		...
		[
			plf.addText({"label":"Calendar Code",id:"strCalenderCode","anywhereSearch":"true"}),
...
[
		...
		{       
				"controlid":"searchBtn",
				"tasktype":"btnclick",
				"input":["strCalenderCode","strCalenderDesc","strStatus"],
				"service":"CoreCalendarMasterService",
				"methodName":"fetchAllCalendarsRosterTS"
			},
			{
				"controlid":"",
				"tasktype":"onload",
				"input":[""],
				"service":"CoreCalendarMasterService",
				"methodName":"initCalenderRosterSearch"
				},
				{
					"tasktype":"proto",
		...
		mainpage.screenLinks=
		{
			"calendarmaster":
				{
					"dest":"jm_master.CalendarNewMaster",
					"hdr":[
							{"src":"","dest":""}							
							],
					"grid":[
