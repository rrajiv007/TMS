...
************************************************************************************************/
Ext.define('CueTrans.view.FX_REGISTRATION.ShipperPDOOPSApproval',
   { 
        ...
        initComponent: function() {
			...
			var ManagersCtrl=
			[
			plf.addText({"label":"Company Name",id:"strCompanyName","mandatory":"true",inputFormat:"string",InputLength:"100",blankText:"Please provide your company's name."}),
			...
			[
			{
				...
				},
				{
					...
					"input":["strCode","strMiddleName","strLastName","strDesignation","strMobileNo","strEmail","strLandlineNo","strExtnNo",
							...
							"strFax","strOrgName","strDepartment","strPurchaseGroup",
					 "strContractHolderName","strContRefIndicator","strContPhoneNo","strContEmail","strContGSM","strCompanyName"],
					"service":"FXCoreTS",
					"methodName":"FXPORTAL_PDOOPSAPPROVALTS"				
				},
				{
                    "controlid":"",
					"tasktype":"toolbarclick",
