...
************************************************************************************************/
Ext.define('CueTrans.view.FX_REGISTRATION.PDOShipperSummary', 
{
		...
		[
			{
				...
				"input":[""],
				"service":"FXCoreTS",
				"methodName":"FXPORTAL_INITPDOSHIPSUMMTS"
			},
			{
				"controlid":"searchBtn",
				"tasktype":"btnclick",
				"input":["strName","strCustCategory","strStatus"],
				"service":"FXCoreTS",
				"methodName":"FXPORTAL_FETCHPDOSHIPSUMMTS"
			}
