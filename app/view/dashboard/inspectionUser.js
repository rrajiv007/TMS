Ext.define('CueTrans.view.dashboard.inspectionUser',
    {
        ...
        initComponent: function() {
			...
			mainpage.screenName = "Inspection Dashboard";
		...
		[
            ...
            Ext.data.StoreManager.lookup('chart1_store').loadData([
				{"yaxis":11,"data1":5000,"xaxis":"VehicleInspection"},
				{"yaxis":7,"data1":1000,"xaxis":"LoadInspection"},
				{"yaxis":3,"data1":4000,"xaxis":"Re-Inspection"},
            ...
            Ext.data.StoreManager.lookup('chart2_store').loadData([
				{"yaxis":21,"data1":5000,"xaxis":"JAN-29"},
				{"yaxis":15,"data1":1000,"xaxis":"JAN-30"},
				{"yaxis":5,"data1":4000,"xaxis":"JAN-31"},
				{"yaxis":7,"data1":1000,"xaxis":"FEB-01"},
				{"yaxis":9,"data1":1000,"xaxis":"FEB-02"},
				{"yaxis":13,"data1":9000,"xaxis":"FEB-03"},
				{"yaxis":15,"data1":1000,"xaxis":"FEB-04"}							
				],false);
			...
			tmpRow1.add(
                ...
                "svgURL": "resources/images/svg/inspection/inspectionUserScreen.svg"
            }))
