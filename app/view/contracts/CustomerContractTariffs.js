...
************************************************************************************************/
Ext.define('CueTrans.view.contracts.CustomerContractTariffs', 
{
	...
	initComponent: function()
	{
		...
		mainpage.screenName = "Customer Contract Tariff Details";
		...
		[
			{"name":"Customer Contracts","linkid":"co_CustomerContractsTar"}
		...
		[
			plf.addDisplayOnly({"label":"Customer Contract No",id:"strContractNo"}),
		...
		[
			...
			{columnname:"Destination",dataname:"DESTINATION",datatype:"string",width:100,editControl:"textbox",inputFormat:"string",InputLength:"40"},
			{columnname:"Vehicle Category",dataname:"VEHICLE_CATEGORY",datatype:"string",editControl:"combo",width:130,storeId:"strVehicleCategory"},
		...
		mainpage.eventHandlers = 
			[
            {
					...
					"methodName":"initCustomerTariffTS"
			},
			{
					"controlid":"",
					"tasktype":"toolbarclick",
					"action":"Save",
					"input":["strContractNo","dtContractDate","strContractDesc","strStatus","strCustomerCode","strCustomerName","dtEffectiveFrom","dtEffectiveTo","iAmendmentNo","strCurrency","iExchangeRate","strBillingDoc","tariffGridObj"],
					"service":"CoreCustomerContract",
					"methodName":"createTariffDetailsTS"
			},
			{
					"controlid":"",
					"tasktype":"toolbarclick",
					...
					"input":["strContractNo"],
					"service":"CoreCustomerContract",
					"methodName":"PrintCustTarrifDetailsReport"
			}			             
			];
		
	mainpage.screenLinks=
		{
			"co_CustomerContractsTar":
				{
