...
Ext.define('CueTrans.view.LSR.JMCLSRApproval',

{
	...
	initComponent: function()
	{
		...
		mainpage.screenName = "JMC LSR Approval Details";
		...
		//  Header Section 	
		plf.columns=4
		var LSRAppHdrColumn = plf.addColumnSection({});			
		var LSRAppHdrCtrl=						
		[    
		...
		LSRAppHdrColumn.add(LSRAppHdrCtrl);
		...
		[   {columnname:"LSR Violation Type Code",dataname:"LSR_TYPE",datatype:"string",editControl:"addDisplayOnly",width:"auto",hidden:true},
			...
			//-------------------------------------------
			{columnname:"LSR Review Action",dataname:"LSR_REVIEW_ACTION",datatype:"string",editControl:"addDisplayOnly",width:"auto",hidden:true},
			...
			//------------------------------
			{columnname:"LSR Approval Action",dataname:"LSR_APPROVAL_ACTION",datatype:"string",editControl:"combo",width:"auto",storeId:"strLSRAppAction"},
			{columnname:"LSR Approval Remarks",dataname:"LSR_APPROVAL_REMARKS",datatype:"string",editControl:"textbox",width:"auto",inputFormat:"string",InputLength:"4000"},
			{columnname:"File Name",dataname:"APP_FILE_NAME",datatype:"string",width:"auto",editControl:"addDisplayOnly"},
			{columnname:"Upload Document",dataname:"APP_UPLOADDOCUMENT",datatype:"string",editControl:"fileupload",fileGroup:"JPLSR/Documents",width:"auto",nameColumn:"APP_FILE_NAME"},
		...
		mainpage.ptrMainSection.add(LSRAppHdrColumn)
		...
		[

		  {
				...
				"methodName":"initJMCLSRApprovalTS"
			},
			{
				...
				"methodName":"onenterJMCLSRApprovalTS"
			},
			{
				"controlid":"",
                ...
                "methodName":"submitJMCLSRApprovalTS"					
			},
			{
				"controlid":"",
				"tasktype":"toolbarclick",
				...
				"input":["strJourneyPlanNo","JMSLSRDTL"],
				"service":"CoreJourneyPlanService",
                "methodName":"AmendJMCLSRApprovalTS"					
			}
		...
		mainpage.hlpLinks=
		{
         "View_Journey":
			...
			"jpno":
				{
					"hlpType":"Header",
					"hlpScreen":"LSR.JMCLSRApprovalHelp",
					"send":[
							{"parent":"","child":""}
						   ],
					"receive":[
