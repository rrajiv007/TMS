...
************************************************************************************************
Description : LSR -LSR Confirmation
Author      : Raj                                                           		         
Version     : 1.0.0
************************************************************************************************	
...
Ext.define('CueTrans.view.LSR.JMCLSRConfirmation',

{
	...
	initComponent: function()
	{
		...
		mainpage.screenName = "JMC LSR Confirmation Details";
		...
		//  Header Section 	
		plf.columns=4
		var LSRConHdrColumn = plf.addColumnSection({});			
		var LSRConHdrCtrl=						
		[    
		...
		LSRConHdrColumn.add(LSRConHdrCtrl);
		...
		[   {columnname:"LSR Violation Type Code",dataname:"LSR_TYPE",datatype:"string",editControl:"addDisplayOnly",width:"auto",hidden:true},
			...
			{columnname:"LSR Confirmation Action",dataname:"LSR_CONFIRM_ACTION",datatype:"string",editControl:"combo",storeId:"strLSRConfirmAction",width:"auto"},
			{columnname:"LSR Confirmation Remarks",dataname:"LSR_CONFIRM_REMARKS",datatype:"string",editControl:"textbox",width:"auto",inputFormat:"string",InputLength:"4000"},
			{columnname:"File Name",dataname:"CON_FILE_NAME",datatype:"string",width:"auto",editControl:"addDisplayOnly"},			
			{columnname:"Upload Document",dataname:"CON_UPLOADDOCUMENT",datatype:"string",editControl:"fileupload",fileGroup:"JPLSR/Documents",width:"auto",nameColumn:"CON_FILE_NAME"},
			...
			{columnname:"LSR Review Action",dataname:"LSR_REVIEW_ACTION",datatype:"string",editControl:"addDisplayOnly",width:"auto"},
		...
		mainpage.ptrMainSection.add(LSRConHdrColumn)
		...
		[

		  {
				...
				"methodName":"initJMCLSRConfirmTS"
			},
			{
				...
				"methodName":"onenterJMCLSRConfirmTS"
			},
			{
				"controlid":"",
                ...
                "methodName":"submitJMCLSRConfirmTS"					
			},
			{
				"controlid":"",
				"tasktype":"toolbarclick",
				...
				"input":["strJourneyPlanNo","JMSLSRDTL"],
				"service":"CoreJourneyPlanService",
                "methodName":"AmendJMCLSRConfirmTS"					
			}
		...
		mainpage.hlpLinks=
		{
         "View_Journey":
			...
			"jpno":
				{
					"hlpType":"Header",
					"hlpScreen":"LSR.JMCLSRConfirmationHelp",
					"send":[
							{"parent":"","child":""}
						   ],
					"receive":[
