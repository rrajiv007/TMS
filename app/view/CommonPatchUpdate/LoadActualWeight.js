...
************************************************************************************************/
Ext.define('CueTrans.view.CommonPatchUpdate.LoadActualWeight', 

{
	...
	initComponent: function()
	{
		...
		mainpage.screenName = "Update Load Actual Weight";
		...
		[
			...
			plf.addText({"label":"Actual Weight (ton)","id":"strWeight","mandatory":"true","inputFormat":"numeric"})
		]
		...
		[   
             ...
             plf.addButton({"label":"Update","id":"ActualWeight",tooltip:"Click here to update load actual weight."})			 
		]
			...
			[
			   {
				...
				{
					"controlid":"ActualWeight",
					"tasktype":"btnclick",
					"input":["strLoadNo","strStatus","strAmendRsn","strWeight"],
					"service":"TMSCoreTransportTS",
					"methodName":"patchActualWeightTs"
				}
			]
