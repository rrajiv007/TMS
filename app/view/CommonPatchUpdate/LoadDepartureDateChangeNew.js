...
************************************************************************************************/
Ext.define('CueTrans.view.CommonPatchUpdate.LoadDepartureDateChangeNew', 

{
	...
	initComponent: function()
	{
		...
		mainpage.screenName = "Load Departure Date Change";
		...
		[   
             ...
             plf.addButton({"label":"Update","id":"LoadDateTm","tooltip":"Click here to change load departure Date and time."})			 
		]
		...
		mainpage.eventHandlers = 
			[
			
			   {
				...
				{
					"controlid":"LoadDateTm",
					"tasktype":"btnclick",
					"input":["strLoadNo","strStatus","dtLoadDate","strAmendRsn","tmLoadTime"],
					"service":"TMSCoreTransportTS",
					"methodName":"patchLoadDeptDateTs"
				}
			]
