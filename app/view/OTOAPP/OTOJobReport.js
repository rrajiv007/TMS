...
************************************************************************************************	
************************************************************************************************/
Ext.define('CueTrans.view.OTOAPP.OTOJobReport', 
{
	...
	initComponent: function()
	{
		...
		/*Cancelled Jobs Starts here*/
		var CancelledJobsObj=
		[
		{columnname:"Job No",dataname:"JOB_NO",datatype:"string",width:150,linkId:"ONGOING_JOB","tooltip":"Click here to view the job."},
		{columnname:"Load No",dataname:"LOAD_NO",datatype:"string",width:200},
		{columnname:"Origin",dataname:"ORIGIN",datatype:"string",width:200},
		...
		var CancelledJobsGridDtl=									
		{
			title:"Cancelled Jobs",
			id:"CancelledJob",
			detail:CancelledJobsObj,
			removeAddDelete:true,
			readonly:true,
			removePaging:true
		}
		var CancelledJobsGridSection = plf.addGrid(CancelledJobsGridDtl,this)
		/*Cancelled Jobs Ends here*/
		...
		mainpage.ptrMainSection.add(CancelledJobsGridSection)
		...
		"methodName":"OTOAPP_INITJOBREPORTSUMMARY"
	    }
		]
