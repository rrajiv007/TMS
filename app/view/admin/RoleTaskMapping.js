...
*/
Ext.define('CueTrans.view.admin.RoleTaskMapping', 
{
extend:"CueTrans.lib.plfTransScreen",
	initComponent: function()
	{
		...
		mainpage.screenName = "Role Screen Task Mapping";
		// Add Toolbar
		...
		[
			{"name":"Role Screen Mapping","linkid":"ad_RoleScreenMapping"}
		]
	roleFormCtrl=
		[
			plf.addHlpText({"label":"Role ID",id:"strRoleIdFrom","mandatory":"true",hlpLinkID:"roleid"},this),
			plf.addDisplayOnly({"label":"Role Name",id:"strRoleDesc","mandatory":"true"}),
			plf.addBlank({}),
		...
		[
			...
			{columnname:"Component Code",dataname:"COMPONENT_ID",datatype:"string",width:150},
			{columnname:"Component Name",dataname:"MODULE_DESC",datatype:"string",width:150},
			{columnname:"Screen Code",dataname:"SCREEN_ID",datatype:"string",width:150},
			{columnname:"Screen Name",dataname:"SCREEN_DESC",datatype:"string",width:150},
			{columnname:"Task Code",dataname:"TASK_ID",datatype:"string",width:150},
			{columnname:"Task Name",dataname:"TASK_DESC",datatype:"string",width:150},
				...
				},
{
        ...
        mainpage.screenModes=
		{
			...
			{
				"enableAll":false,
				"except":["strRoleIdFrom"]
			},
			"active":
			{
				"enableAll":false,
				"except":["roleDtlCache","strRoleIdFrom"]
			}			
		}
		...
		mainpage.screenLinks=
		{
				...
				"ad_RoleScreenMapping":
				{
					"dest":"admin.RoleScreenMapping",
					"hdr":[
							{"src":"","dest":""}							
							],
					"grid":[
