...
************************************************************************************************/
Ext.define('CueTrans.view.PDOFinance.PDOViewCarrierOPSOTOBill', 
{
	...
	initComponent: function()
	{
		...
		mainpage.screenName = "OTO Standard Approval";		
		...
		*/
		...
		/*{
			"name": "Print Bank Advise",
			"tooltip": "Click here to print bank advice."
		},*/
		{
			"name": "Print Summary",
		...
		[   
			...
			{columnname:"Cancel Load",dataname:"CAN_LOAD",datatype:"string",width:80,linkId:"cancellink",heading:true,gridpopup:true,tooltip:"Click here to cancel load.",imageURL:"resources/images/gridbar/delete.png"}			
		]
		var loaddetGridDtl=			
		{
			title:"",
		...
		var OTOStandardColumn = plf.addCollapseSection({"title":"Summary",collapsed:true});	
		...
		mainpage.ptrMainSection.add(OTOStandardColumn);
		...
		[
		
			{
				...
				"methodName":"PDOinitViewCarOTOBillTS"
			},	
			...
			{       
				...
				"service":"FINCoreFinanceServiceTS",
				"methodName":"PDOSubViewCarOTOBillTS"
			},
			{       
				"controlid":"",
				"tasktype":"toolbarclick",
