...
************************************************************************************************/
Ext.define('CueTrans.view.PDOFinance.PDOViewCarrierBill', 
{
		...
		*/
		...
		if(plf.defaultLayout==4)
		{
			...
			[	
				...
				//plf.addDisplayOnly({"label":"Payment Status",id:"strPayStatus"})
		...
		var BtnCtrl=							
		[				
			plf.addButton({"label":"Save & Re-Calculate","id":"btnSave"}),			
		...
		var baseTab = plf.addTabSection({columnWidth:1,tabs:[LoadDetailsColumn,LoadSummaryColumn,OTOStandardColumn,SumitomoColumn,DuqmSumitomoColumn,SafaLoadColumn,NorthDiversionColumn,SouthDiversionColumn,ContractorColumn]});
		...
		[
		
			{
				...
				"methodName":"PDOinitViewCarBillTS"
			},
			{       
				"controlid":"btnRecalc",
				"tasktype":"btnclick",				
		...
		mainpage.gridPopupLinks=
		{
			...
			"GRP_OTOSTD_load_Leg_link":
			{
				...
				"grid":[
						...
						{"src":"BILL_NO","dest":"strBillNo"},
						{"src":"LOAD_CAT","dest":"strLoadCat"},
						{"src":"GRP_OTOSTD","dest":"strLoadType"}						
						]
			},
			"GRP_SUMITOMO_load_Leg_link":
			{
				"dest":"PDOFinance.LoadLegsDetails",
				"popMethodName":"initFinLoadLegPopupTS",
				"hdr":[
				...
				"grid":[
						...
						{"src":"BILL_NO","dest":"strBillNo"},
						{"src":"LOAD_CAT","dest":"strLoadCat"},
						{"src":"GRP_SUMITOMO","dest":"strLoadType"}						
						]
			},
			"GRP_DUQMSUMITOMO_load_Leg_link":
			{
				"dest":"PDOFinance.LoadLegsDetails",
				"popMethodName":"initFinLoadLegPopupTS",
				"hdr":[
				...
				"grid":[
						...
						{"src":"BILL_NO","dest":"strBillNo"},
						{"src":"LOAD_CAT","dest":"strLoadCat"},
						{"src":"GRP_DUQMSUMITOMO","dest":"strLoadType"}						
						]
			},
			"GRP_NORTHDIV_load_Leg_link":
			{
				"dest":"PDOFinance.LoadLegsDetails",
				"popMethodName":"initFinLoadLegPopupTS",
				"hdr":[
				...
				"grid":[
						...
						{"src":"BILL_NO","dest":"strBillNo"},
						{"src":"LOAD_CAT","dest":"strLoadCat"},
						{"src":"GRP_NORTHDIV","dest":"strLoadType"}						
						]
			},
			"GRP_SOUTHDIV_load_Leg_link":
			{
				"dest":"PDOFinance.LoadLegsDetails",
				"popMethodName":"initFinLoadLegPopupTS",
				"hdr":[
				...
				"grid":[
						...
						{"src":"BILL_NO","dest":"strBillNo"},
						{"src":"LOAD_CAT","dest":"strLoadCat"},
						{"src":"GRP_SOUTHDIV","dest":"strLoadType"}						
						]
			}*/
		}
