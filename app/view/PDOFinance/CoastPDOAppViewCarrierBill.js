...
************************************************************************************************/
Ext.define('CueTrans.view.PDOFinance.CoastPDOAppViewCarrierBill', 
{
	...
	initComponent: function()
	{
		...
		mainpage.screenName = "Coastal PDO Approval";
		...
		[
		
			{
				...
				"methodName":"initViewCostalPDOBillTS"//PDOinitViewCarBillTS
			},
			{       
				"controlid":"",
				...
				"input":["strBillNo"],
				"service":"FINCoreFinanceServiceTS",
				"methodName":"SubmitCoastPDOOTOBillTS"
			},
			{       
				"controlid":"btnRecalc",
				"tasktype":"btnclick",				
			...
			{       
				...
				"input":["loadDetailsGrid","strBillNo"],
				"service":"FINCoreFinanceServiceTS",
				"methodName":"SaveCoastPDOOTOBillTS"
			},
			{       
				"controlid":"btnDelete",
				"tasktype":"btnclick",				
