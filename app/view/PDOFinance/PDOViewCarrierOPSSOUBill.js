...
************************************************************************************************/
Ext.define('CueTrans.view.PDOFinance.PDOViewCarrierOPSSOUBill', 
{
	...
	initComponent: function()
	{
		...
		mainpage.screenName = "South Diversion Approval";		
		...
		[
		
			{
				...
				"methodName":"PDOinitViewCarSOUBillTS"
			},	
			...
			{       
				...
				"service":"FINCoreFinanceServiceTS",
				"methodName":"PDOSubViewCarSOUBillTS"
			},
			{       
				"controlid":"",
				"tasktype":"toolbarclick",
