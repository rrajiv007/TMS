...
************************************************************************************************/
Ext.define('CueTrans.view.PDOFinance.PDOViewCarrierPDONORBill', 
{
	...
	initComponent: function()
	{
		...
		mainpage.screenName = "North Diversion PDO Approval";		
		...
		var NorthDiversionColumn = plf.addCollapseSection({"title":"Summary",collapsed:false});	
		...
		mainpage.ptrMainSection.add(NorthDiversionColumn);
		...
		[
		
			{
				...
				"methodName":"PDOinitViewPDONORBillTS"
			},				
			{       
				"controlid":"",
				...
				"service":"FINCoreFinanceServiceTS",
				"methodName":"PDOSubViewPDONORBillTS"
			},
			{       
				"controlid":"",
				"tasktype":"toolbarclick",
