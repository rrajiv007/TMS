...
************************************************************************************************/
Ext.define('CueTrans.view.PDOFinance.PDOViewCarrierOPSNORBill', 
{
	...
	initComponent: function()
	{
		...
		mainpage.screenName = "North Diversion Approval";		
		...
		[
		
			{
				...
				"methodName":"PDOinitViewCarNORBillTS"
			},				
			{       
				"controlid":"",
				...
				"service":"FINCoreFinanceServiceTS",
				"methodName":"PDOSubViewCarNORBillTS"
			},
			{       
				"controlid":"",
				"tasktype":"toolbarclick",
