...
************************************************************************************************/
Ext.define('CueTrans.view.PDOFinance.PDOViewCarrierPDOSUMIBill', 
{
	...
	initComponent: function()
	{
		...
		mainpage.screenName = "Sohar Sumitomo PDO Approval";		
		...
		[
		
			{
				...
				"methodName":"PDOinitViewPDOSUMBillTS"
			},			
			{       
				"controlid":"",
				...
				"service":"FINCoreFinanceServiceTS",
				"methodName":"PDOSubViewPDOSUMIBillTS"
			},
			{        
				"controlid":"",
				"tasktype":"toolbarclick",
