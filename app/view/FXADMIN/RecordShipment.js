Ext.define('CueTrans.view.FXADMIN.RecordShipment', 
/****************************************************************************************************************
...
****************************************************************************************************************/
{
	...
	initComponent: function()
	{
		...
		mainpage.screenName = "Shipment Receipt Summary";
		mainpage.toolbarSectionFlag=true;
		mainpage.toolbarLinks=
		[
		//	{"name":"Receipt Shipment","linkid":"REC_SHIP","tooltip":"Click here for  receipt shipments."}
			...
			[
			 {
				...
				"input":[""],
				"service":"FXCoreTS",
				"methodName":"FXPORTAL_INITSHIPRECPTSUMTS"
		      }
				/*  
               {
				"controlid":"",
