Ext.define('CueTrans.view.FXADMIN.CCShipments', 
/****************************************************************************************************************
...
****************************************************************************************************************/
{
	...
	initComponent: function()
	{
		...
		mainpage.screenName = "Shipment Consolidation Center";
		...
		[
			plf.addText({"label":"Weight(tons)","id":"strWeight",inputFormat:"numeric",weightPrecision:"2","mandatory":"true"}),
			plf.addText({"label":"Volume(cum)","id":"strVolume", inputFormat:"numeric",weightPrecision:"2","mandatory":"true"}),
