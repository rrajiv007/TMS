Ext.define('CueTrans.view.FXADMIN.ManageShipments', 
/****************************************************************************************************************
...
****************************************************************************************************************/
{
	...
	initComponent: function()
	{
		...
		[
			...
			plf.addButton({id:"btnGetRate",label:"Get Rate",tooltip:"Click here to get rate."}),
			...
			plf.addCombo({"label":"Reason","id":"strRejReason"}),
		]
		...
		mainpage.dataHistorySectionFlag=true;
			...
			[
			  ...
			  {       
				...
				"service":"FXCoreTS",
				"methodName":"FXPORTAL_SESENDQUOTESTS"
			 },
			 {       
				"controlid":"",
				"tasktype":"toolbarclick",
				"action":"Reject",
				"input":["strShipmentNo","strRejReason"],
				"service":"FXCoreTS",
				"methodName":"FXPORTAL_SEREJECTSTS"
			 },
