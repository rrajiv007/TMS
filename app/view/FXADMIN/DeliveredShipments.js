Ext.define('CueTrans.view.FXADMIN.DeliveredShipments', 
/****************************************************************************************************************
...
****************************************************************************************************************/
{
	...
	initComponent: function()
	{
		...
		mainpage.screenName = "Delivered Shipment Summary";
		mainpage.toolbarSectionFlag=true;
		mainpage.toolbarLinks=
		[
			//{"name":"Delivered Shipments","linkid":"DELV_SHIPMENTS","tooltip":"Click here for delivered shipments."}
		...
		mainpage.dataHistorySectionFlag=false;
			...
			[
			{
				...
				"input":[""],
				"service":"FXCoreTS",
				"methodName":"FXPORTAL_INITSHIPDELVDSUMTS"
		      }
				/*  
               {
				"controlid":"",
		...
		mainpage.screenLinks=
		{
				...
				"DELV_SHIPMENTS":
				{
					"dest":"FXADMIN.DelvShipmentsMain",
					"hdr":[
							{"src":"","dest":""}							
							],
					"grid":[
